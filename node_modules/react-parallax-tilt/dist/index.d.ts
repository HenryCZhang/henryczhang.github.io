...
declare type SupportedEvent = DOMSupportedEvent | CustomEvent<CustomEventType>;

declare type GlareProps = {
    /**
...
declare type GlarePosition = 'top' | 'right' | 'bottom' | 'left' | 'all';

declare type TiltProps = {
    /**
...
declare type OnMove = (onMoveParams: OnMoveParams) => void;
declare type HtmlDivTilt = Pick<React.HTMLAttributes<HTMLDivElement>, 'className' | 'style'>;
declare type ReactParallaxTiltProps = TiltProps & GlareProps & HtmlDivTilt & {
    /**
